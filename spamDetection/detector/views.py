...
from sklearn.feature_extraction.text import CountVectorizer #for converting text data into nume
...
dataset = pd.read_csv('C:/Users/shali/Desktop/spam detector/spamDetection/emails.csv')
